...
int printArray(struct CharFreq alphaList[], int alphaNum, struct CharFreq digitList[], int digitNum);
...
int main(int argc, char* argv[]){
    ...
    if (alphaNum < 5) {
        ...
        /*printf("alphaNum for this file: %d \n", alphaNum);*/
    ...
    /*printf("digitNum for this file: %d \n", digitNum);*/
    if (digitNum < 5) {
        printf("alpha top %d out of %d \n", digitNum, digitNum);
        printf("--------------------- \n");
